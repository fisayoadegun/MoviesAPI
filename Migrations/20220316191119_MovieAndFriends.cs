    ...
    public partial class MovieAndFriends : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviesTheatersMovies", x => new { x.MovieTheaterId, x.MovieId });
                    table.ForeignKey(
                        name: "FK_MoviesTheatersMovies_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MoviesTheatersMovies_MovieTheaters_MovieTheaterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoviesTheatersMovies_MovieId",
                table: "MoviesTheatersMovies",
                column: "MovieId");
        }
